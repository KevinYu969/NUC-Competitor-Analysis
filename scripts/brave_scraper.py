...
SEARCH_QUERIES = {
    "general_competitor": [
        ...
        "Lenovo ThinkCentre Neo Ultra Strix Halo",
        "HP Z2 Mini G1a review",
        "Minisforum UMI2 Strix Halo review",
        "Gigabyte BRIX Pro AI Strix Halo",
        "Dell OptiPlex AMD Ryzen AI mini PC",
        "Acer mini PC AMD Ryzen AI 2025",
        "mini PC AMD Zen5 competitor comparison",
    ],
    ...
    "halo_oem_feedback": [
        ...
        "HP Z2 Mini G1a Strix Halo experience",
        "white label Strix Halo mini PC quality",
        "Strix Halo OEM comparison quality build",
        "mini PC brand comparison Strix Halo build quality",
    ],
    "halo_rocm_feedback": [
...
PRODUCT_KEYWORDS = {
    ...
    "lenovo": ["lenovo", "thinkcentre", "neo ultra"],
    "hp": ["hp ", "z2 mini", "z2 mini g1a", "hp z2"],
    "dell": ["dell", "optiplex"],
    "minisforum": ["minisforum", "umi2"],
    "gigabyte": ["gigabyte", "brix"],
    "acer": ["acer", "revo"],
}
